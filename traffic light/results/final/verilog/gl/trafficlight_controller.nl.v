...
module trafficlight_controller (clear,
    clock,
    x,
    hwy,
    road);
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_15_64 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_16_62 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_17_83 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_27_23 ();
 ...
 sky130_fd_sc_hd__inv_2 _29_ (.A(net1),
    .Y(_08_));
 sky130_fd_sc_hd__inv_2 _30_ (.A(net3),
    .Y(_09_));
 sky130_fd_sc_hd__nor3b_2 _31_ (.A(\delay[2] ),
    .B(\delay[0] ),
    .C_N(\delay[1] ),
    .Y(_10_));
 sky130_fd_sc_hd__nor2_1 _32_ (.A(net1),
    .B(_10_),
    .Y(_11_));
 sky130_fd_sc_hd__a32o_1 _33_ (.A1(_08_),
    .A2(_09_),
    .A3(\state[4] ),
    .B1(_11_),
    .B2(\state[1] ),
    .X(_01_));
 sky130_fd_sc_hd__nor2_1 _34_ (.A(\delay[2] ),
    .B(\delay[1] ),
    .Y(_12_));
 sky130_fd_sc_hd__and2_1 _35_ (.A(_08_),
    .B(\state[2] ),
    .X(_13_));
 sky130_fd_sc_hd__nor2_1 _36_ (.A(net1),
    .B(_09_),
    .Y(_14_));
 sky130_fd_sc_hd__a32o_1 _37_ (.A1(\delay[0] ),
    .A2(_12_),
    .A3(_13_),
    .B1(_14_),
    .B2(\state[4] ),
    .X(_04_));
 sky130_fd_sc_hd__or3b_1 _38_ (.A(\delay[2] ),
    .B(\delay[1] ),
    .C_N(\delay[0] ),
    .X(_15_));
 sky130_fd_sc_hd__a32o_1 _39_ (.A1(_08_),
    .A2(\state[3] ),
    .A3(_10_),
    .B1(_15_),
    .B2(_13_),
    .X(_02_));
 sky130_fd_sc_hd__a221o_1 _40_ (.A1(_09_),
    .A2(\state[0] ),
    .B1(_10_),
    .B2(\state[1] ),
    .C1(net1),
    .X(_00_));
 sky130_fd_sc_hd__a22o_1 _41_ (.A1(\state[3] ),
    .A2(_11_),
    .B1(_14_),
    .B2(\state[0] ),
    .X(_03_));
 sky130_fd_sc_hd__clkbuf_1 _42_ (.A(\state[4] ),
    .X(_16_));
 sky130_fd_sc_hd__clkbuf_1 _43_ (.A(_16_),
    .X(net6));
 sky130_fd_sc_hd__clkbuf_1 _44_ (.A(\state[1] ),
    .X(_17_));
 sky130_fd_sc_hd__clkbuf_1 _45_ (.A(_17_),
    .X(net7));
 sky130_fd_sc_hd__or2_1 _46_ (.A(\state[1] ),
    .B(\state[3] ),
    .X(_18_));
 sky130_fd_sc_hd__nor3_1 _47_ (.A(\state[4] ),
    .B(\state[2] ),
    .C(_18_),
    .Y(net4));
 sky130_fd_sc_hd__buf_1 _48_ (.A(\state[3] ),
    .X(_19_));
 sky130_fd_sc_hd__clkbuf_1 _49_ (.A(_19_),
    .X(net5));
 sky130_fd_sc_hd__o31a_1 _50_ (.A1(\state[1] ),
    .A2(\state[2] ),
    .A3(\state[3] ),
    .B1(\delay[0] ),
    .X(_20_));
 sky130_fd_sc_hd__or3_1 _51_ (.A(\delay[0] ),
    .B(\state[2] ),
    .C(_18_),
    .X(_21_));
 sky130_fd_sc_hd__a21oi_1 _52_ (.A1(_10_),
    .A2(_18_),
    .B1(net1),
    .Y(_22_));
 sky130_fd_sc_hd__and3b_1 _53_ (.A_N(_20_),
    .B(_21_),
    .C(_22_),
    .X(_23_));
 sky130_fd_sc_hd__clkbuf_1 _54_ (.A(_23_),
    .X(_05_));
 sky130_fd_sc_hd__o311a_1 _55_ (.A1(\state[1] ),
    .A2(\state[2] ),
    .A3(\state[3] ),
    .B1(\delay[0] ),
    .C1(\delay[1] ),
    .X(_24_));
 sky130_fd_sc_hd__or4b_1 _56_ (.A(\state[1] ),
    .B(\state[3] ),
    .C(_15_),
    .D_N(\state[2] ),
    .X(_25_));
 sky130_fd_sc_hd__or2_1 _57_ (.A(\delay[1] ),
    .B(_20_),
    .X(_26_));
 sky130_fd_sc_hd__and4b_1 _58_ (.A_N(_24_),
    .B(_22_),
    .C(_25_),
    .D(_26_),
    .X(_27_));
 sky130_fd_sc_hd__clkbuf_1 _59_ (.A(_27_),
    .X(_06_));
 sky130_fd_sc_hd__o21ai_1 _60_ (.A1(\delay[2] ),
    .A2(_24_),
    .B1(_08_),
    .Y(_28_));
 sky130_fd_sc_hd__a21oi_1 _61_ (.A1(\delay[2] ),
    .A2(_24_),
    .B1(_28_),
    .Y(_07_));
 sky130_fd_sc_hd__dfxtp_1 _62_ (.CLK(net2),
    .D(_00_),
    .Q(\state[0] ));
 sky130_fd_sc_hd__dfxtp_1 _63_ (.CLK(net2),
    .D(_01_),
    .Q(\state[1] ));
 sky130_fd_sc_hd__dfxtp_1 _64_ (.CLK(net2),
    .D(_02_),
    .Q(\state[2] ));
 sky130_fd_sc_hd__dfxtp_2 _65_ (.CLK(net2),
    .D(_03_),
    .Q(\state[3] ));
 sky130_fd_sc_hd__dfxtp_1 _66_ (.CLK(net2),
    .D(_04_),
    .Q(\state[4] ));
 sky130_fd_sc_hd__dfxtp_1 _67_ (.CLK(net2),
    .D(_05_),
    .Q(\delay[0] ));
 sky130_fd_sc_hd__dfxtp_1 _68_ (.CLK(net2),
    .D(_06_),
    .Q(\delay[1] ));
 sky130_fd_sc_hd__dfxtp_1 _69_ (.CLK(net2),
    .D(_07_),
    .Q(\delay[2] ));
 sky130_fd_sc_hd__clkbuf_2 input1 (.A(clear),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_2 input2 (.A(clock),
    .X(net2));
 sky130_fd_sc_hd__buf_1 input3 (.A(x),
    .X(net3));
